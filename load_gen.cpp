...
void thread_handler(int seconds, int *thread_requests, float *thread_resptime){
    ...
    auto resp_time = chrono::duration_cast<chrono::milliseconds>(resp_recvd-req_sent);
    ...
    do {
        ...
        if (cmd == 1) {
            ...
            resp_time = chrono::duration_cast<chrono::milliseconds>(resp_recvd-req_sent);
    ...
    *thread_resptime = total_resptime;
}
